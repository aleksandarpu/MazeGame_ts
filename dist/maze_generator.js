export function generateBraidedMaze(width, height) {
    ...
    function carvePassages(currentX, currentY) {
        ...
        for (const dir of directions) {
            ...
            if (nextX >= 0 &&
                ...
                grid[nextY][nextX].walls[dir.oppWall] = false;
            ...
            for (let x = 0; x < width; x++) {
                ...
                if (wallCount === 3) {
                    ...
                    if (breakableWalls.length > 0) {
                        ...
                        grid[y + randomWall.dy][x + randomWall.dx].walls[randomWall.opp] = false;
                    }
                }
            }
        }
