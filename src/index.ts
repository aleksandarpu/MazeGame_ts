...
import { renderGameRoomScreen, RoomPlayer } from "./game-room-screen";
...
function navigateToGameRoom() {
  ...
  renderGameRoomScreen(
    appContainer,
    "Alpha Room", // Fetch real name from Firestore
...
function navigateToGamePlay() {
  ...
  const cleanupGameInputs = renderGamePlayScreen(
    appContainer,
    initialGameState,
    advanceTurn,
    updatePlayer,
